...
set.seed(s+200)
	...
	#D = sapply(1:2, function(r){(-1)^r*rep(2, Time)})
...
set.seed(s)
M3 = DLFM_Dunson_fixed(Ys, Xnew, RE = c("additive", "multiplicative"), gammapriors = c(2, 1), dist = "Exponential", avail = matrix(1, Time , N), R =2, burn = 1000, nscan = 5000, odens = 10, kappas = rep(0.001, 4))
